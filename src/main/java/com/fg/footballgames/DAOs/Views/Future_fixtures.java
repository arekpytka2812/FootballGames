...
public class Future_fixtures implements IDaoViewModel {
    private String HOST;
    ...
    public Future_fixtures(String HOST, String GUEST, String HOST_GOALS, String GUEST_GOALS, String STADIUM, String DATE, String REFEREE) {
        this.HOST = HOST;
        this.GUEST = GUEST;
